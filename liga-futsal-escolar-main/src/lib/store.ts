export const defaultData = {
  ...
  sponsorsPremium: [
    { id: 1, name: "FERREIRA COSTA", logo: "https://upload.wikimedia.org/wikipedia/commons/7/7b/Ferreira_Costa_logo.svg" },
    { id: 2, name: "UNICOMPRA", logo: "https://logo.clearbit.com/unicompra.com.br" }
  ],
  sponsorsOfficial: [
    { id: 1, name: "BÔNUS", logo: "https://logo.clearbit.com/supermercadosbonus.com.br" },
    { id: 2, name: "SESC PE", logo: "https://upload.wikimedia.org/wikipedia/commons/c/ca/SESC_logo.svg" },
    { id: 3, name: "O BOTICÁRIO", logo: "https://upload.wikimedia.org/wikipedia/commons/d/dd/O_Botic%C3%A1rio_Logo.svg" },
    { id: 4, name: "PREFEITURA DE GARANHUNS", logo: "https://upload.wikimedia.org/wikipedia/commons/1/13/Bras%C3%A3o_Garanhuns.png" }
  ],
  settings: {
